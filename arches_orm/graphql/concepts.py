...
from arches_orm.resource_api.datatypes.concepts import invalidate_collection, retrieve_collection

# RMV from arches.app.utils.skos import SKOSReader
...
TERM_SEP = "》"
LANG = "en" # RMV get_language() or "en"
